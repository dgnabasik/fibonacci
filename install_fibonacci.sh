...
git clone https://github.com/dgnabasik/fibonacci  # -OR- go get github.com/dgnabasik/fibonacci/...
docker-compose up --build
echo "Open another terminal and execute: cd ~/github.com/dgnabasik/fibonacci && sudo ./migration.sh "
